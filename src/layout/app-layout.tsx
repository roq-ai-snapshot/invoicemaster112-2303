...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'dispute', path: '/disputes', entity: 'dispute', service: AccessServiceEnum.PROJECT, icon: FiHome },
  ...
  { name: 'report', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiHome },
